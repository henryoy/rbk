<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="GenerarVisita.aspx.cs" Inherits="Dashboard_Notificacion_asignarventa" %>
    ...
    <div id="mainWrapper" class="credits-row-titles" style="padding-top: 26px;">
        <div id="plans-info" class="empty_campaigns credits-info">
            ...
            <div class="Visitaright">
                <asp:LinkButton runat="server" ID="lnkActualizarNot" CssClass="submit-btn-vista brandBgColor brandBgColorHover font-semibold confirm-login" OnClick="lnkActualizarNot_Click">Generar visita</asp:LinkButton>
            </div>
        </div>
    ...
    <div id="popupOverlay" style="opacity: 1; transition: all 0.46s ease; display: none;">
        <div id="popup" style="opacity: 1; transition: all 0.46s ease; transform: scale(1) translateY(-50%);">
            ...
            <input type="button" value="Cancelar" class="btnFalse semi_bold" style="right: 0px; width: 50%;" onclick="closePopup();"><div id="sub_data_info" class="bold">
                <img src="<%: ResolveUrl("~/Content/img/icons/default.png") %>">Registrar visita
            </div>
            <asp:UpdatePanel runat="server" ID="upMpdal">
                <ContentTemplate>
                    ...
                    <div runat="server" id="mainWrapper2" visible="false">
                        <p>No se logro registrar la visita</p>
                    </div>
                </ContentTemplate>
                <Triggers>
