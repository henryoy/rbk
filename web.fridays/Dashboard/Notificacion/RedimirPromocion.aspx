    ...
    <div id="mainWrapper" class="credits-row-titles" style="padding-top: 26px;">
        <div id="plans-info" class="empty_campaigns credits-info">
            ...
            <div class="right">
                ...
                <asp:LinkButton runat="server" ID="lnkActualizarNot" CssClass="submit-btn brandBgColor brandBgColorHover font-semibold confirm-login">Asignar Folio</asp:LinkButton>
            </div>
        </div>
