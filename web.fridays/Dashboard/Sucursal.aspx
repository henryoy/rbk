<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Sucursal.aspx.cs" Inherits="Dashboard_Sucursal" %>
    ...
    <div id="campaigns" class="disable_selection semi_bold">
        ...
        <div id="list_name_bar">
            ...
            <div id="action" class="semi_bold disable campaigns_action">
                <h3 class="disable" style="width: 114px;">Opciones
        ...
        <div id="mainWrapper">
            <div id="box_row_titles">
                ...
                <div id="row_titles2">
                    ...
                    <input type="button" value=" " id="add_subscriber" class="semi_bold">
                </div>
            </div>
